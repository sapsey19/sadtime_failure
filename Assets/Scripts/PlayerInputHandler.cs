...
public class PlayerInputHandler : MonoBehaviour {
    ...
    public float GetLookInputsHorizontal() {
        return Input.GetAxis(GameConstants.k_MouseAxisNameHorizontal) * sensitivity * Time.fixedDeltaTime * sensMultiplier; 
    }

    public float GetLookInputsVertical() {
        return Input.GetAxis(GameConstants.k_MouseAxisNameVertical) * sensitivity * Time.fixedDeltaTime * sensMultiplier;
    }
